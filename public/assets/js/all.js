...
(() => {
    var e = {
        23: (e, t, n) => {
            ...
            function r() {
                ...
                var _ = m.prototype = h.prototype = Object.create(g);
                ...
                return p.prototype = m, u(_, "constructor", m), u(m, "constructor", p), p.displayName = u(m, l, "GeneratorFunction"), e.isGeneratorFunction = function (e) {
                    var t = "function" == typeof e && e.constructor;
                    return !!t && (t === p || "GeneratorFunction" === (t.displayName || t.name))
                }, e.mark = function (e) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(e, m) : (e.__proto__ = m, u(e, l, "GeneratorFunction")), e.prototype = Object.create(_), e
                }, e.awrap = function (e) {
                    return {
                        __await: e
                    }
                    ...
                    return this
                })), e.AsyncIterator = w, e.async = function (t, n, i, r, o) {
                    void 0 === o && (o = Promise);
                    var a = new w(c(t, n, i, r), o);
                    return e.isGeneratorFunction(n) ? a : a.next().then((function (e) {
                        return e.done ? e.value : a.next()
                    }))
                }, b(_), u(_, l, "Generator"), u(_, a, (function () {
                    return this
            ...
            function s() {
                return (s = a(r().mark((function e() {
                    var t;
                    return r().wrap((function (e) {
                        for (; ;) switch (e.prev = e.next) {
                            case 0:
                                $(".ui-menu").html('<img src="/assets/images/loading.gif" width="50px"/>'), t = $(".manga-search-field").val(), $.ajax({
                                    ...
                                    beforeSend: function () { },
                                    success: function (e) {
                                        $(".ui-menu").html(""), "" === e ? $(".ui-menu").append(label_button_no_more) : $(".ui-menu").append(e.data), $(".ui-menu").attr("style", "display: block")
                                    },
                                    complete: function (e, t) { }
                                });
                            case 3:
            ...
            function l() {
                var e;
                if ((e = JSON.parse(localStorage["visited-comics"])).length > 0) {
                    for (var t = 0, n = $(".widget-content.history-content"), i = $(".widget-content.history-content span").html(), r = e.length - 1; r >= 0; r--) {
                        var o = e[r],
                            a = '<div class="popular-item-wrap t-item"><div class="popular-img widget-thumbnail c-image-hover"><a title="' + o.name + '" href="' + o.url + '"><img width="70" height="60" class="img-responsive" src="' + o.image + '" alt="' + o.name + '"> </a></a></div><div class="popular-content"><div class="widget-title line-3"><a title="' + o.name + '" href="' + o.url + '">' + o.name + '</a></div><div class="list-chapter"><div class="chapter-item "><span class="chapter font-meta"><a href="' + o.chapterUrl + '" class="btn-link">' + o.chapterName + '</a></span><span class="view pull-right"><a class="visited-remove" data-id="' + o.id + '"><i class="icon ion-md-close"></i> Del</a></span></div></div></div></div>';
                        if (n.append(a), ++t > 2) break
                    }
                    n.append('<a class="widget-view-more" href="' + i + '">' + show_more + "</a>")
                }
            }
            ...
            function u() {
                var e;
                if ((e = JSON.parse(localStorage["visited-comics"])).length > 0) {
                    for (var t = $(".tab-item-history .row"), n = "", i = e.length - 1; i >= 0; i--) {
                        var r = e[i];
                        n += '<div class="col-md-4"><div class="history-content"><div class="item-thumb"> <a title="' + r.name + '" href="' + r.url + '"><img width="100" height="60" class="img-responsive" src="' + r.image + '" alt="' + r.name + '"></a></div><div class="item-infor"><div class="settings-title"><h3 class="line-2 font-16"><a title="' + r.name + '" href="' + r.url + '">' + r.name + '</a></h3></div><div class="chapter"><span class="chap"><a href="' + r.chapterUrl + '" class="btn-link">' + r.chapterName + '</a></span></div></div><div class="action"><span class="view pull-right"><a class="visited-remove" data-id="' + r.id + '"><i class="icon ion-ios-close"></i></a></span></div></div></div>'
                    }
                    t.append(n)
                }
            }
            window.$ = window.jQuery = n(755), window.Popper = n(981), n(734), $(document).ready((function () {
                ...
                if ("undefined" != typeof Storage && void 0 !== localStorage.theme) {
                    var t = $("body");
                    "dark" === localStorage.theme ? (t.addClass("text-ui-light"), t.removeClass("text-ui-dark"), $(".switch>input").prop("checked", !0)) : (t.removeClass("text-ui-light"), t.addClass("text-ui-dark"))
                }
                ...
                var i, r, o, a = $(".menu_icon__open"),
                    c = $(".menu_icon__close"),
                    f = $(".off-canvas"),
                    d = $(".mobile-menu .btn-active-modal");
                a.on("click", (function () {
                    a.addClass("active"), f.addClass("active"), $("body").addClass("open_canvas")
                })), c.on("click", (function (e) {
                    e.preventDefault(), a.removeClass("active"), f.removeClass("active"), $("body").removeClass("open_canvas")
                ...
                })), $(".manga-search-field").on("keyup", (i = function () {
                    ! function () {
                    ...
                    var e = $("body");
                    e.toggleClass("text-ui-light"), localStorage.theme = e.hasClass("text-ui-light") ? "dark" : "light";
                    var t = $(".switch checkbox");
                    1 == t.prop("checked") ? t.prop("checked", !1) : t.prop("checked", !0)
                })), $(".history").length && "undefined" != typeof Storage && void 0 !== localStorage["visited-comics"] && setTimeout(l, 500), $(".tab-item-history").length && "undefined" != typeof Storage && void 0 !== localStorage["visited-comics"] && setTimeout(u, 550),
                    $(".wp-manga-delete-bookmark").each((function () {
                        $(this).on("click", (function (e) {
                            e.preventDefault();
                            var t = $(this),
                                n = $("#token").val(),
                                i = $(this).data("post"),
                                r = $(this).data("bookmark");
                            $.ajax({
                                url: r,
                                type: "POST",
                                data: {
                                ...
                                success: function (e) {
                                    "unbookmark" === e.action && t.parents("tr").remove()
                                }
                            })
                        }))
                    }))
            ...
            $(document).ready((function () {
                $(".load-ajax-last-update").on("click", (function () {
                    ...
                    $.ajax({
                        ...
                        beforeSend: function () {
                            $(".load-ajax-last-update").find(".load-title").append('<img width="40" height="40" src="assets/images/loading.gif" class="img-loading" />')
                        },
                        success: function (t) {
        ...
        978: (e, t, n) => {
            ...
            e = n.nmd(e), r = "undefined" != typeof window ? window : {}, o = function (e, t, n) {
                ...
                var o = t.documentElement,
                    ...
                    b = function e(t, n, i) {
                        var r = i ? s : "removeEventListener";
                        i && e(t, n), p.forEach((function (e) {
                            t[r](e, n)
                        }))
                    },
                    w = function (e, n, r, o, a) {
                    ...
                    C = function () {
                        var e, n, i = [],
                            ...
                            s = function (i, r) {
                                e && !r ? i.apply(this, arguments) : (o.push(i), n || (n = !0, (t.hidden ? c : f)(a)))
                            };
                    ...
                    k = function (e) {
                        ...
                        return function (e) {
                            var r;
                            (e = !0 === e) && (a = 33), t || (t = !0, (r = o - (n.now() - i)) < 0 && (r = 0), e || r < 9 ? l() : c(l, r))
                        }
                    },
                    N = function (e) {
                        var t, i, r = function () {
                    ...
                    A = function () {
                        var a, d, p, m, T, A, j, O, L, I, P, q, H = /^img$/i,
                            R = /^iframe$/i,
                            ...
                            U = function (e, n) {
                                var i, r = e,
                                    a = z(e);
                                for (O -= n, P += n, L -= n, I += n; a && (r = r.offsetParent) && r != t.body && r != o;)(a = (E(r, "opacity") || 1) > 0) && "visible" != E(r, "overflow") && (i = r.getBoundingClientRect(), a = I > i.left && L < i.right && P > i.top - 1 && O < i.bottom + 1);
                                return a
                            },
                            Q = function () {
                                var e, n, s, u, c, f, h, p, g, v, y, _, b = i.elements;
                                if ((m = r.loadMode) && $ < 8 && (e = b.length)) {
                                    for (n = 0, B++; n < e; n++)
                                        if (b[n] && !b[n]._lazyRace)
                                            if (!F || i.prematureUnveil && i.prematureUnveil(b[n])) Z(b[n]);
                                            else if ((p = b[n][l]("data-expand")) && (f = 1 * p) || (f = M), v || (v = !r.expand || r.expand < 1 ? o.clientHeight > 500 && o.clientWidth > 500 ? 500 : 370 : r.expand, i._defEx = v, y = v * r.expFactor, _ = r.hFac, q = null, M < y && $ < 1 && B > 2 && m > 2 && !t.hidden ? (M = y, B = 0) : M = m > 1 && B > 1 && $ < 6 ? v : 0), g !== f && (A = innerWidth + f * _, j = innerHeight + f, h = -1 * f, g = f), s = b[n].getBoundingClientRect(), (P = s.bottom) >= h && (O = s.top) <= j && (I = s.right) >= h * _ && (L = s.left) <= A && (P || I || L || O) && (r.loadHidden || z(b[n])) && (d && $ < 3 && !p && (m < 3 || B < 4) || U(b[n], f))) {
                                                if (Z(b[n]), c = !0, $ > 9) break
                                            } else !c && d && !u && $ < 4 && B < 4 && m > 2 && (a[0] || r.preloadAfterLoad) && (a[0] || !p && (P || I || L || O || "auto" != b[n][l](r.sizesAttr))) && (u = a[0] || b[n]);
                                    u && !c && Z(u)
                                }
                            },
                            V = k(Q),
                            X = function (e) {
                                var t = e.target;
                                t._lazyCache ? delete t._lazyCache : (W(e), y(t, r.loadedClass), _(t, r.loadingClass), b(t, G), w(t, "lazyloaded"))
                            },
                            Y = S(X),
                            G = function (e) {
                                Y({
                            ...
                            J = S((function (e, t, n, i, o) {
                                var a, s, u, f, d, m;
                                (d = w(e, "lazybeforeunveil", t)).defaultPrevented || (i && (n ? y(e, r.autosizesClass) : e.setAttribute("sizes", i)), s = e[l](r.srcsetAttr), a = e[l](r.srcAttr), o && (f = (u = e.parentNode) && h.test(u.nodeName || "")), m = t.firesLoad || "src" in e && (s || a || f), d = {
                                    target: e
                                }, y(e, r.loadingClass), m && (clearTimeout(p), p = c(W, 2500), b(e, G, !0)), f && g.call(u.getElementsByTagName("source"), K), s ? e.setAttribute("srcset", s) : a && !f && (R.test(e.nodeName) ? function (e, t) {
                                    var n = e.getAttribute("data-load-mode") || r.iframeLoadMode;
                                    0 == n ? e.contentWindow.location.replace(t) : 1 == n && (e.src = t)
                                }(e, a) : e.src = a), o && (s || f) && x(e, {
                                    src: a
                                })), e._lazyRace && delete e._lazyRace, _(e, r.lazyClass), C((function () {
                                    var t = e.complete && e.naturalWidth > 1;
                                    m && !t || (t && y(e, r.fastLoadedClass), X(d), e._lazyCache = !0, c((function () {
                            ...
                            Z = function (e) {
                                if (!e._lazyRace) {
                                    var t, n = H.test(e.nodeName),
                                        ...
                                        o = "auto" == i;
                                    (!o && d || !n || !e[l]("src") && !e.srcset || e.complete || v(e, r.errorClass) || !v(e, r.lazyClass)) && (t = w(e, "lazyunveilread").detail, o && D.updateElem(e, !0, e.offsetWidth), e._lazyRace = !0, $++, J(e, t, o, i, n))
                                }
                            },
                            ee = N((function () {
                                r.loadMode = 3, V()
                            ...
                            ne = function e() {
                                d || (n.now() - T < 999 ? c(e, 999) : (d = !0, r.loadMode = 3, V(), u("scroll", te, !0)))
                            };
                        return {
                            _: function () {
                                T = n.now(), i.elements = t.getElementsByClassName(r.lazyClass), a = t.getElementsByClassName(r.lazyClass + " " + r.preloadClass), u("scroll", V, !0), u("resize", V, !0), u("pageshow", (function (e) {
                                    if (e.persisted) {
                                    ...
                                    subtree: !0,
                                    attributes: !0
                                }) : (o[s]("DOMNodeInserted", V, !0), o[s]("DOMAttrModified", V, !0), setInterval(V, 999)), u("hashchange", V, !0), ["focus", "mouseover", "click", "load", "transitionend", "animationend"].forEach((function (e) {
                                    t[s](e, V, !0)
                                })), /d$|^c/.test(t.readyState) ? ne() : (u("load", ne), t[s]("DOMContentLoaded", V), c(ne, 2e4)), i.elements.length ? (Q(), C._lsFlush()) : V()
                            },
                            checkElems: V,
                            unveil: Z,
                            _aLSL: te
                    ...
                    D = function () {
                        var e, n = S((function (e, t, n, i) {
                            ...
                            i = function (e, t, i) {
                                ...
                                o && (i = T(e, o, i), r = w(e, "lazybeforesizes", {
                                    width: i,
                                    dataAttr: !!t
                    ...
                    j = function e() {
                        !e.i && t.getElementsByClassName && (e.i = !0, D._(), A._())
                    };
                return c((function () {
                    r.init && j()
                })), i = {
        ...
        707: () => {
            jQuery(document).ready((function (e) {
                var t = {
                    ...
                    n = '<div class="modal-loading-screen"><div class="fa-5x"><img width="40" height="40" src="assets/images/loading.gif" class="img-loading" /></div></div>';
                e(".modal form").each((function () {
                    ...
                    var r = e("#registerform input[name='user_sign-up']").val(),
                        ...
                        a = e("#registerform input[name='email_sign-up']").val(),
                        s = (e("#registerform .g-recaptcha-response").val(), e("#register_url").val()),
                        l = e("#token").val(),
                        u = e(".c-modal_item"),
                        c = e(this).parents(".modal-content");
                    return "" === r ? (e("p.message.register").text(t.messages.username_cannot_empty), !1) : "" === a ? (e("p.message.register").text(t.messages.email_cannot_empty), !1) : "" === o ? (e("p.message.sign-up").text(t.messages.password_cannot_empty), !1) : (jQuery.ajax({
                        url: s,
                        type: "POST",
                        data: {
                            name: r,
                    ...
                    if (i.preventDefault(), !e("body").hasClass("logged-in")) {
                        var r = e("#loginform input[name='log']").val(),
                            ...
                            a = e("#loginform input[name='rememberme']").val(),
                            s = e(".c-modal_item"),
                            l = e("#login_url").val(),
                            u = e("#token").val();
                        ...
                        return "" == r ? (e("p.message.login").text(t.messages.email_cannot_empty), !1) : "" == o ? (e("p.message.login").text(t.messages.password_cannot_empty), !1) : (jQuery.ajax({
                            ...
                            success: function (t) {
                                if (1 == t.success) {
                                    if (e(".modal#form-login").hide(), e(".modal-backdrop").hide(), e(document).trigger("manga-login-success"), e("body").addClass("logged-in"), 0 != s.length) s.html();
                                    s.empty(), s.append(t.data)
                                }
                            },
                            complete: function (e, t) {
                    ...
                    var a = e("#reset_url").val(),
                        s = e(this).parents(".modal-content");
                    jQuery.ajax({
                        url: a,
                        type: "POST",
                        data: {
                        ...
                        complete: function () {
                            var e = s.find(".modal-loading-screen");
                            void 0 !== e && e.remove()
                        }
                    })
                    ...
                    var i = e(this),
                        ...
                        a = i.find('input[name="user"]').val(),
                        s = i.find('input[name="key"]').val(),
                    ...
                    return "" == r || "" == o ? (l.text(t.messages.please_fill_all_fields), !1) : r.length < 12 ? (l.text(t.messages.password_cannot_less_than_12), !1) : r !== o ? (l.text(t.messages.password_doesnot_match), !1) : void e.ajax({
                        ...
                        beforeSend: function () {
                            u.append('<div class="modal-loading-screen"><div class="fa-5x"><img width="40" height="40" src="assets/images/loading.gif" class="img-loading" /></div></div>')
                        },
                        success: function (e) {
        ...
        734: function (e, t, n) {
            ! function (e, t, n) {
                ...
                function v() {
                    r.default.fn.emulateTransitionEnd = g, r.default.event.special[y.TRANSITION_END] = m()
                }
                var y = {
                    ...
                    jQueryDetection: function () {
                        ...
                        var e = r.default.fn.jquery.split(" ")[0].split("."),
                            ...
                            o = 1,
                            a = 4;
                        if (e[0] < n && e[1] < i || e[0] === t && e[1] === i && e[2] < o || e[0] >= a) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
                    }
                };
                y.jQueryDetection(), v();
                var _ = "alert",
                    ...
                    O = function () {
                        ...
                        return t.close = function (e) {
                            ...
                            var t = y.getSelectorFromElement(e),
                                n = !1;
                            return t && (n = document.querySelector(t)), n || (n = r.default(e).closest("." + C)[0]), n
                        }, t._triggerCloseEvent = function (e) {
                            var t = r.default.Event(N);
                            return r.default(e).trigger(t), t
                        }, t._removeElement = function (e) {
                            var t = this;
                            if (r.default(e).removeClass(k), r.default(e).hasClass(S)) {
                ...
                r.default(document).on(D, j, O._handleDismiss(new O)), r.default.fn[_] = O._jQueryInterface, r.default.fn[_].Constructor = O, r.default.fn[_].noConflict = function () {
                    return r.default.fn[_] = T, O._jQueryInterface
                };
                var L = "button",
                    I = "4.6.2",
                    P = "bs.button",
                    ...
                    J = function () {
                        ...
                        return t.toggle = function () {
                            var e = !0,
                                t = !0,
                                n = r.default(this._element).closest(Q)[0];
                            if (n) {
                                ...
                                if (i) {
                                    if ("radio" === i.type)
                                        ...
                                        } e && ("checkbox" !== i.type && "radio" !== i.type || (i.checked = !this._element.classList.contains(F)), this.shouldAvoidTriggerChange || r.default(i).trigger("change")), i.focus(), t = !1
                                }
                            }
                ...
                r.default(document).on(B, U, (function (e) {
                    var t = e.target,
                        n = t;
                    if (r.default(t).hasClass(M) || (t = r.default(t).closest(K)[0]), !t || t.hasAttribute("disabled") || t.classList.contains("disabled")) e.preventDefault();
                    else {
                        var i = t.querySelector(Y);
                        if (i && (i.hasAttribute("disabled") || i.classList.contains("disabled"))) return void e.preventDefault();
                        "INPUT" !== n.tagName && "LABEL" === t.tagName || J._jQueryInterface.call(r.default(t), "toggle", "INPUT" === n.tagName)
                    }
                })).on(W, U, (function (e) {
                    var t = r.default(e.target).closest(K)[0];
                    r.default(t).toggleClass($, /^focus(in)?$/.test(e.type))
                })), r.default(window).on(z, (function () {
                ...
                })), r.default.fn[L] = J._jQueryInterface, r.default.fn[L].Constructor = J, r.default.fn[L].noConflict = function () {
                    return r.default.fn[L] = R, J._jQueryInterface
                };
                var Z = "carousel",
                    ee = "4.6.2",
                    te = "bs.carousel",
                    ...
                    Ue = function () {
                        ...
                        return t.next = function () {
                            ...
                            e || (this._isPaused = !0), this._element.querySelector(Re) && (y.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
                        }, t.cycle = function (e) {
                            ...
                            if (!(e > this._items.length - 1 || e < 0))
                                if (this._isSliding) r.default(this._element).one(xe, (function () {
                                    return t.to(e)
                                }));
                                else {
                            ...
                            this._config.keyboard && r.default(this._element).on(Ee, (function (t) {
                                return e._keydown(t)
                            })), "hover" === this._config.pause && r.default(this._element).on(Te, (function (t) {
                                return e.pause(t)
                            })).on(Ce, (function (t) {
                                return e.cycle(t)
                            ...
                            if (this._touchSupported) {
                                ...
                                r.default(this._element.querySelectorAll(He)).on(je, (function (e) {
                                    return e.preventDefault()
                                })), this._pointerEvent ? (r.default(this._element).on(Ae, (function (e) {
                                    return t(e)
                                })), r.default(this._element).on(De, (function (e) {
                                    return i(e)
                                })), this._element.classList.add(ge)) : (r.default(this._element).on(Se, (function (e) {
                                    return t(e)
                                })), r.default(this._element).on(ke, (function (e) {
                                    return n(e)
                                })), r.default(this._element).on(Ne, (function (e) {
                                    return i(e)
                                })))
                            }
                            ...
                            var a = (r + (e === ye ? -1 : 1)) % this._items.length;
                            ...
                            if (this._indicatorsElement) {
                                ...
                                r.default(t).removeClass(ce);
                                var n = this._indicatorsElement.children[this._getItemIndex(e)];
                                n && r.default(n).addClass(ce)
                            }
                            ...
                            var n, i, o, a = this,
                                s = this._element.querySelector(Pe),
                                l = this._getItemIndex(s),
                                u = t || s && this._getItemByDirection(e, s),
                                c = this._getItemIndex(u),
                                f = Boolean(this._interval);
                            if (e === ve ? (n = he, i = pe, o = _e) : (n = de, i = me, o = be), u && r.default(u).hasClass(ce)) this._isSliding = !1;
                                ...
                                if (r.default(this._element).hasClass(fe)) {
                                    ...
                                    r.default(s).one(y.TRANSITION_END, (function () {
                                        r.default(u).removeClass(n + " " + i).addClass(ce), r.default(s).removeClass(ce + " " + i + " " + n), a._isSliding = !1, setTimeout((function () {
                                            return r.default(a._element).trigger(d)
                                        }), 0)
                                    })).emulateTransitionEnd(h)
                                } else r.default(s).removeClass(ce), r.default(u).addClass(ce), this._isSliding = !1, r.default(this._element).trigger(d);
                                f && this.cycle()
                            }
                        }, e._jQueryInterface = function (t) {
                            return this.each((function () {
                                var n = r.default(this).data(te),
                                    i = l({}, Be, r.default(this).data());
                            ...
                            if (n) {
                                var i = r.default(n)[0];
                                if (i && r.default(i).hasClass(ue)) {
                                    var o = l({}, r.default(i).data(), r.default(this).data()),
                                        a = this.getAttribute("data-slide-to");
                                    a && (o.interval = !1), e._jQueryInterface.call(r.default(i), o), a && r.default(i).data(te).to(a), t.preventDefault()
                                }
                            }
                        }, s(e, null, [{
                            key: "VERSION",
                ...
                r.default(document).on(Le, Me, Ue._dataApiClickHandler), r.default(window).on(Oe, (function () {
                ...
                var Qe = "collapse",
                    ...
                    ht = function () {
                        ...
                        var t = e.prototype;
                        return t.toggle = function () {
                            r.default(this._element).hasClass(Je) ? this.hide() : this.show()
                        }, t.show = function () {
                            var t, n, i = this;
                            if (!(this._isTransitioning || r.default(this._element).hasClass(Je) || (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(ut)).filter((function (e) {
                                ...
                                if (r.default(this._element).trigger(o), !o.isDefaultPrevented()) {
                                    ...
                                    r.default(this._element).removeClass(Ze).addClass(et), this._element.style[a] = 0, this._triggerArray.length && r.default(this._triggerArray).removeClass(tt).attr("aria-expanded", !0), this.setTransitioning(!0);
                                    var s = function () {
                                        r.default(i._element).removeClass(et).addClass(Ze + " " + Je), i._element.style[a] = "", i.setTransitioning(!1), r.default(i._element).trigger(ot)
                                    },
                            ...
                            var e = this;
                            if (!this._isTransitioning && r.default(this._element).hasClass(Je)) {
                                var t = r.default.Event(at);
                                if (r.default(this._element).trigger(t), !t.isDefaultPrevented()) {
                                    var n = this._getDimension();
                                    this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", y.reflow(this._element), r.default(this._element).addClass(et).removeClass(Ze + " " + Je);
                                    var i = this._triggerArray.length;
                                    if (i > 0)
                                        for (var o = 0; o < i; o++) {
                                            var a = this._triggerArray[o],
                                                s = y.getSelectorFromElement(a);
                                            null !== s && (r.default([].slice.call(document.querySelectorAll(s))).hasClass(Je) || r.default(a).addClass(tt).attr("aria-expanded", !1))
                                        }
                                    this.setTransitioning(!0);
                                    var l = function () {
                                        e.setTransitioning(!1), r.default(e._element).removeClass(et).addClass(Ze).trigger(st)
                                    };
                            ...
                            return (e = l({}, ft, e)).toggle = Boolean(e.toggle), y.typeCheckConfig(Qe, e, dt), e
                ...
                r.default(document).on(lt, ct, (function (e) {
                ...
                })), r.default.fn[Qe] = ht._jQueryInterface, r.default.fn[Qe].Constructor = ht, r.default.fn[Qe].noConflict = function () {
                    return r.default.fn[Qe] = Ke, ht._jQueryInterface
                };
                var pt = "dropdown",
                    mt = "4.6.2",
                    gt = "bs.dropdown",
                    ...
                    tn = function () {
                        ...
                        var t = e.prototype;
                        return t.toggle = function () {
                            if (!this._element.disabled && !r.default(this._element).hasClass(kt)) {
                                var t = r.default(this._menu).hasClass(Nt);
                                e._clearMenus(), t || this.show(!0)
                            }
                        }, t.show = function (t) {
                            if (void 0 === t && (t = !1), !(this._element.disabled || r.default(this._element).hasClass(kt) || r.default(this._menu).hasClass(Nt))) {
                                var n = {
                                    relatedTarget: this._element
                                },
                                    i = r.default.Event(qt, n),
                                ...
                                if (r.default(a).trigger(i), !i.isDefaultPrevented()) {
                                    if (!this._inNavbar && t) {
                                        ...
                                        var s = this._element;
                                        "parent" === this._config.reference ? s = a : y.isElement(this._config.reference) && (s = this._config.reference, void 0 !== this._config.reference.jquery && (s = this._config.reference[0])), "scrollParent" !== this._config.boundary && r.default(a).addClass(Lt), this._popper = new o.default(s, this._menu, this._getPopperConfig())
                                    }
                                    "ontouchstart" in document.documentElement && 0 === r.default(a).closest(Ut).length && r.default(document.body).children().on("mouseover", null, r.default.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), r.default(this._menu).toggleClass(Nt), r.default(a).toggleClass(Nt).trigger(r.default.Event(Ht, n))
                                }
                            }
                        }, t.hide = function () {
                            if (!this._element.disabled && !r.default(this._element).hasClass(kt) && r.default(this._menu).hasClass(Nt)) {
                                var t = {
                                    relatedTarget: this._element
                                },
                                    n = r.default.Event(It, t),
                                    i = e._getParentFromElement(this._element);
                                r.default(i).trigger(n), n.isDefaultPrevented() || (this._popper && this._popper.destroy(), r.default(this._menu).toggleClass(Nt), r.default(i).toggleClass(Nt).trigger(r.default.Event(Pt, t)))
                            }
                        }, t.dispose = function () {
                            ...
                            var e = this;
                            r.default(this._element).on(Rt, (function (t) {
                                t.preventDefault(), t.stopPropagation(), e.toggle()
                            }))
                        }, t._getConfig = function (e) {
                            return e = l({}, this.constructor.Default, r.default(this._element).data(), e), y.typeCheckConfig(pt, e, this.constructor.DefaultType), e
                            ...
                            var e = r.default(this._element.parentNode),
                                t = Yt;
                            return e.hasClass(At) ? t = r.default(this._menu).hasClass(Ot) ? Xt : Vt : e.hasClass(Dt) ? t = Kt : e.hasClass(jt) ? t = Jt : r.default(this._menu).hasClass(Ot) && (t = Gt), t
                            ...
                            if (!t || t.which !== Ct && ("keyup" !== t.type || t.which === xt))
                                for (var n = [].slice.call(document.querySelectorAll(Bt)), i = 0, o = n.length; i < o; i++) {
                                    var a = e._getParentFromElement(n[i]),
                                        s = r.default(n[i]).data(gt),
                                        l = {
                                            relatedTarget: n[i]
                                        };
                                    if (t && "click" === t.type && (l.clickEvent = t), s) {
                                        var u = s._menu;
                                        if (r.default(a).hasClass(Nt) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && t.which === xt) && r.default.contains(a, t.target))) {
                                            var c = r.default.Event(It, l);
                                            r.default(a).trigger(c), c.isDefaultPrevented() || ("ontouchstart" in document.documentElement && r.default(document.body).children().off("mouseover", null, r.default.noop), n[i].setAttribute("aria-expanded", "false"), s._popper && s._popper.destroy(), r.default(u).removeClass(Nt), r.default(a).removeClass(Nt).trigger(r.default.Event(Pt, l)))
                                        }
                                    }
                                }
                            ...
                            if (!(/input|textarea/i.test(t.target.tagName) ? t.which === wt || t.which !== bt && (t.which !== Tt && t.which !== Et || r.default(t.target).closest(zt).length) : !St.test(t.which)) && !this.disabled && !r.default(this).hasClass(kt)) {
                                var n = e._getParentFromElement(this),
                                    i = r.default(n).hasClass(Nt);
                                if (i || t.which !== bt) {
                                    if (t.preventDefault(), t.stopPropagation(), !i || t.which === bt || t.which === wt) return t.which === bt && r.default(n.querySelector(Bt)).trigger("focus"), void r.default(this).trigger("click");
                                    var o = [].slice.call(n.querySelectorAll(Qt)).filter((function (e) {
                                        return r.default(e).is(":visible")
                                    }));
                                    if (0 !== o.length) {
                                        var a = o.indexOf(t.target);
                                        t.which === Et && a > 0 && a--, t.which === Tt && a < o.length - 1 && a++, a < 0 && (a = 0), o[a].focus()
                                    }
                                }
                            }
                        }, s(e, null, [{
                ...
                r.default(document).on(Mt, Bt, tn._dataApiKeydownHandler).on(Mt, zt, tn._dataApiKeydownHandler).on(Ft + " " + $t, tn._clearMenus).on(Ft, Bt, (function (e) {
                    e.preventDefault(), e.stopPropagation(), tn._jQueryInterface.call(r.default(this), "toggle")
                })).on(Ft, Wt, (function (e) {
                    e.stopPropagation()
                })), r.default.fn[pt] = tn._jQueryInterface, r.default.fn[pt].Constructor = tn, r.default.fn[pt].noConflict = function () {
                    return r.default.fn[pt] = _t, tn._jQueryInterface
                };
                var nn = "modal",
                    rn = "4.6.2",
                    on = "bs.modal",
                    ...
                    Hn = function () {
                        ...
                        return t.toggle = function (e) {
                            ...
                            if (!this._isShown && !this._isTransitioning) {
                                ...
                                r.default(this._element).trigger(n), n.isDefaultPrevented() || (this._isShown = !0, r.default(this._element).hasClass(pn) && (this._isTransitioning = !0), this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), r.default(this._element).on(Tn, On, (function (e) {
                                    return t.hide(e)
                                })), r.default(this._dialog).on(kn, (function () {
                                    r.default(t._element).one(Sn, (function (e) {
                            ...
                            if (e && e.preventDefault(), this._isShown && !this._isTransitioning) {
                                ...
                                if (r.default(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                                    ...
                                    if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), r.default(document).off(xn), r.default(this._element).removeClass(mn), r.default(this._element).off(Tn), r.default(this._dialog).off(kn), i) {
                            ...
                            return e = l({}, Pn, e), y.typeCheckConfig(nn, e, qn), e
                        }, t._triggerBackdropTransition = function () {
                            var e = this,
                                t = r.default.Event(yn);
                            if (r.default(this._element).trigger(t), !t.isDefaultPrevented()) {
                                var n = this._element.scrollHeight > document.documentElement.clientHeight;
                                n || (this._element.style.overflowY = "hidden"), this._element.classList.add(gn);
                                ...
                                r.default(this._element).off(y.TRANSITION_END), r.default(this._element).one(y.TRANSITION_END, (function () {
                                    e._element.classList.remove(gn), n || r.default(e._element).one(y.TRANSITION_END, (function () {
                            ...
                            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), r.default(this._dialog).hasClass(cn) && i ? i.scrollTop = 0 : this._element.scrollTop = 0, n && y.reflow(this._element), r.default(this._element).addClass(mn), this._config.focus && this._enforceFocus();
                            ...
                            this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._showBackdrop((function () {
                                r.default(document.body).removeClass(hn), e._resetAdjustments(), e._resetScrollbar(), r.default(e._element).trigger(_n)
                            }))
                            ...
                            if (this._isShown && this._config.backdrop) {
                                if (this._backdrop = document.createElement("div"), this._backdrop.className = dn, n && this._backdrop.classList.add(n), r.default(this._backdrop).appendTo(document.body), r.default(this._element).on(Tn, (function (e) {
                                    t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === t._config.backdrop ? t._triggerBackdropTransition() : t.hide())
                                })), n && y.reflow(this._backdrop), r.default(this._backdrop).addClass(mn), !e) return;
                                if (!n) return void e();
                                ...
                                r.default(this._backdrop).removeClass(mn);
                                var o = function () {
                            ...
                            r.default(document.body).addClass(hn)
                            ...
                            return this.each((function () {
                                var i = r.default(this).data(on),
                                    o = l({}, Pn, r.default(this).data(), "object" == typeof t && t ? t : {});
                ...
                r.default(document).on(Nn, jn, (function (e) {
                    var t, n = this,
                        i = y.getSelectorFromElement(this);
                    i && (t = document.querySelector(i));
                    var o = r.default(t).data(on) ? "toggle" : l({}, r.default(t).data(), r.default(this).data());
                    "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
                    var a = r.default(t).one(bn, (function (e) {
                        e.isDefaultPrevented() || a.one(_n, (function () {
                            r.default(n).is(":visible") && n.focus()
                        }))
                    }));
                    Hn._jQueryInterface.call(r.default(t), o, this)
                })), r.default.fn[nn] = Hn._jQueryInterface, r.default.fn[nn].Constructor = Hn, r.default.fn[nn].noConflict = function () {
                    return r.default.fn[nn] = ln, Hn._jQueryInterface
                };
                ...
                function Bn(e, t) {
                    ...
                    if (-1 !== t.indexOf(n)) return -1 === Rn.indexOf(n) || Boolean(Mn.test(e.nodeValue) || $n.test(e.nodeValue));
                        ...
                        return t.enable = function () {
                            ...
                            if (this.isWithContent() && this._isEnabled) {
                                ...
                                if (r.default(this.tip).hasClass(Jn)) {
                                    ...
                                    r.default(this.tip).one(y.TRANSITION_END, f).emulateTransitionEnd(d)
                                } else f()
                            }
                        }, t.hide = function (e) {
                            var t = this,
                            ...
                            this.setElementContent(r.default(e.querySelectorAll(ni)), this.getTitle()), r.default(e).removeClass(Jn + " " + Zn)
                            ...
                            return Object.keys(t).forEach((function (e) {
                                ...
                                show: e.delay,
                                hide: e.delay
                            }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), y.typeCheckConfig(zn, e, this.constructor.DefaultType), e.sanitize && (e.template = Wn(e.template, e.whiteList, e.sanitizeFn)), e
                            ...
                            null === e.getAttribute("x-placement") && (r.default(e).removeClass(Jn), this.config.animation = !1, this.hide(), this.show(), this.config.animation = t)
                        }, e._jQueryInterface = function (t) {
                            return this.each((function () {
                                var n = r.default(this),
                                    i = n.data(Qn),
                                    o = "object" == typeof t && t;
                                if ((i || !/dispose|hide/.test(t)) && (i || (i = new e(this, o), n.data(Qn, i)), "string" == typeof t)) {
                                    if (void 0 === i[t]) throw new TypeError('No method named "' + t + '"');
                                    i[t]()
                                }
                            }))
                ...
                r.default.fn[zn] = di._jQueryInterface, r.default.fn[zn].Constructor = di, r.default.fn[zn].noConflict = function () {
                    return r.default.fn[zn] = Xn, di._jQueryInterface
                };
                var hi = "popover",
                    pi = "4.6.2",
                    mi = "bs.popover",
                    ...
                    ki = function (e) {
                        ...
                        return n.isWithContent = function () {
                            ...
                            return this.each((function () {
                                var n = r.default(this).data(mi),
                                    i = "object" == typeof e ? e : null;
                                if ((n || !/dispose|hide/.test(e)) && (n || (n = new t(this, i), r.default(this).data(mi, n)), "string" == typeof e)) {
                ...
                r.default.fn[hi] = ki._jQueryInterface, r.default.fn[hi].Constructor = ki, r.default.fn[hi].noConflict = function () {
                    return r.default.fn[hi] = vi, ki._jQueryInterface
                };
                var Ni = "scrollspy",
                    Ai = "4.6.2",
                    Di = "bs.scrollspy",
                    ...
                    Ki = function () {
                        function e(e, t) {
                            var n = this;
                            this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(t), this._selector = this._config.target + " " + Wi + "," + this._config.target + " " + Ui + "," + this._config.target + " " + Vi, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, r.default(this._scrollElement).on(Hi, (function (e) {
                                return n._process(e)
                        ...
                        return t.refresh = function () {
                            var e = this,
                                t = this._scrollElement === this._scrollElement.window ? Fi : Mi,
                            ...
                            if ("string" != typeof (e = l({}, Yi, "object" == typeof e && e ? e : {})).target && y.isElement(e.target)) {
                                var t = r.default(e.target).attr("id");
                                t || (t = y.getUID(Ni), r.default(e.target).attr("id", t)), e.target = "#" + t
                            }
                            return y.typeCheckConfig(Ni, e, Gi), e
                            ...
                            n.hasClass(Ii) ? (n.closest(Qi).find(Xi).addClass(Pi), n.addClass(Pi)) : (n.addClass(Pi), n.parents(Bi).prev(Wi + ", " + Ui).addClass(Pi), n.parents(Bi).prev(zi).children(Wi).addClass(Pi)), r.default(this._scrollElement).trigger(qi, {
                                relatedTarget: e
                            })
                        }, t._clear = function () {
                ...
                })), r.default.fn[Ni] = Ki._jQueryInterface, r.default.fn[Ni].Constructor = Ki, r.default.fn[Ni].noConflict = function () {
                    return r.default.fn[Ni] = Li, Ki._jQueryInterface
                };
                var Ji = "tab",
                    Zi = "4.6.2",
                    er = "bs.tab",
                    ...
                    wr = function () {
                        ...
                        return t.show = function () {
                            var e = this;
                            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && r.default(this._element).hasClass(or) || r.default(this._element).hasClass(ar) || this._element.hasAttribute("disabled"))) {
                                var t, n, i = r.default(this._element).closest(mr)[0],
                            ...
                            r.default(e).addClass(or), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), y.reflow(e), e.classList.contains(sr) && e.classList.add(lr);
                            var o = e.parentNode;
                            if (o && "LI" === o.nodeName && (o = o.parentNode), o && r.default(o).hasClass(rr)) {
                                var a = r.default(e).closest(pr)[0];
                                if (a) {
                ...
                r.default(document).on(hr, yr, (function (e) {
                    e.preventDefault(), wr._jQueryInterface.call(r.default(this), "show")
                })), r.default.fn[Ji] = wr._jQueryInterface, r.default.fn[Ji].Constructor = wr, r.default.fn[Ji].noConflict = function () {
                    return r.default.fn[Ji] = ir, wr._jQueryInterface
                };
                var xr = "toast",
                    Er = "4.6.2",
                    Tr = "bs.toast",
                    ...
                    Fr = function () {
                        ...
                        return t.show = function () {
                            ...
                            if (r.default(this._element).trigger(t), !t.isDefaultPrevented()) {
                                ...
                                var n = function () {
                                    e._element.classList.remove(Dr), e._element.classList.add(Ar), r.default(e._element).trigger(Pr), e._config.autohide && (e._timeout = setTimeout((function () {
                                        e.hide()
                                    }), e._config.delay))
                                };
                                if (this._element.classList.remove(Nr), y.reflow(this._element), this._element.classList.add(Dr), this._config.animation) {
                            ...
                            if (this._element.classList.contains(Ar)) {
                                var e = r.default.Event(Or);
                                r.default(this._element).trigger(e), e.isDefaultPrevented() || this._close()
                            }
                        }, t.dispose = function () {
                            this._clearTimeout(), this._element.classList.contains(Ar) && this._element.classList.remove(Ar), r.default(this._element).off(jr), r.default.removeData(this._element, Tr), this._element = null, this._config = null
                        }, t._getConfig = function (e) {
                            return e = l({}, Hr, r.default(this._element).data(), "object" == typeof e && e ? e : {}), y.typeCheckConfig(xr, e, this.constructor.DefaultType), e
                        }, t._setListeners = function () {
                            var e = this;
                            r.default(this._element).on(jr, qr, (function () {
                                return e.hide()
                            }))
                        }, t._close = function () {
                            var e = this,
                                t = function () {
                                    e._element.classList.add(Nr), r.default(e._element).trigger(Lr)
                                };
                            ...
                            return this.each((function () {
                                var n = r.default(this),
                                    i = n.data(Tr);
                                if (i || (i = new e(this, "object" == typeof t && t), n.data(Tr, i)), "string" == typeof t) {
                                    if (void 0 === i[t]) throw new TypeError('No method named "' + t + '"');
                                    i[t](this)
                                }
                            }))
                ...
                r.default.fn[xr] = Fr._jQueryInterface, r.default.fn[xr].Constructor = Fr, r.default.fn[xr].noConflict = function () {
                    return r.default.fn[xr] = Sr, Fr._jQueryInterface
                }, e.Alert = O, e.Button = J, e.Carousel = Ue, e.Collapse = ht, e.Dropdown = tn, e.Modal = Hn, e.Popover = ki, e.Scrollspy = Ki, e.Tab = wr, e.Toast = Fr, e.Tooltip = di, e.Util = y, Object.defineProperty(e, "__esModule", {
                    value: !0
                })
            }(t, n(755), n(981))
        },
        755: function (e, t) {
            ...
            ! function (t, n) {
                ...
                T.fn = T.prototype = {
                    ...
                    for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || v(a) || (a = {}), s === l && (a = this, s--); s < l; s++)
                        if (null != (e = arguments[s]))
                            for (t in e) i = e[t], "__proto__" !== t && a !== i && (u && i && (T.isPlainObject(i) || (r = Array.isArray(i))) ? (n = a[t], o = r && !Array.isArray(n) ? [] : r || T.isPlainObject(n) ? n : {}, r = !1, a[t] = T.extend(u, o, i)) : void 0 !== i && (a[t] = i));
                    return a
                }, T.extend({
                ...
                var S = function (e) {
                    var t, n, i, r, o, a, s, l, u, c, f, d, h, p, m, g, v, y, _, b = "sizzle" + 1 * new Date,
                        w = e.document,
                        x = 0,
                        E = 0,
                        T = le(),
                    ...
                    for (t in n = se.support = {}, o = se.isXML = function (e) {
                        ...
                        })), g = g.length && new RegExp(g.join("|")), v = v.length && new RegExp(v.join("|")), t = J.test(p.compareDocumentPosition), _ = t || J.test(p.contains) ? function (e, t) {
                                ...
                                return 1 === i && 0 === r ? function (e) {
                                    ...
                                    if (g) {
                                        ...
                                        if (p = [a ? g.firstChild : g.lastChild], a && y) {
                                            for (_ = (h = (u = (c = (f = (d = g)[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === x && u[1]) && u[2], d = h && g.childNodes[h]; d = ++h && d && d[m] || (_ = h = 0) || p.pop();)
                                            ...
                                            for (;
                                                (d = ++h && d && d[m] || (_ = h = 0) || p.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++_ || (y && ((c = (f = d[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [x, _]), d !== t)););
                    ...
                    function Ee(e, t, n, i, r, o) {
                        return i && !i[b] && (i = Ee(i)), r && !r[b] && (r = Ee(r, o)), ue((function (o, a, s, l) {
                            var u, c, f, d = [],
                                h = [],
                                p = a.length,
                                m = o || function (e, t, n) {
                                ...
                                v = n ? r || (o ? e : p || i) ? [] : a : g;
                            if (n && n(g, v, s, l), i)
                                for (u = xe(v, h), i(u, [], s, l), c = u.length; c--;)(f = u[c]) && (v[h[c]] = !(g[h[c]] = f));
                            if (o) {
                                if (r || e) {
                                    if (r) {
                    ...
                    return ye.prototype = i.filters = i.pseudos, i.setFilters = new ye, a = se.tokenize = function (e, t) {
                        ...
                        var n, r = [],
                            ...
                            s = S[e + " "];
                        if (!s) {
                            for (t || (t = a(e)), n = t.length; n--;)(s = Te(t[n]))[b] ? r.push(s) : o.push(s);
                            s = S(e, function (e, t) {
                                var n = t.length > 0,
                                    r = e.length > 0,
                ...
                (T.fn.init = function (e, t, n) {
                    ...
                    if (n = n || L, "string" == typeof e) {
                        ...
                        if (i[1]) {
                            if (t = t instanceof T ? t[0] : t, T.merge(this, T.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : _, !0)), j.test(i[1]) && T.isPlainObject(t))
                                            ...
                                            var s = this,
                                                ...
                                                u = function () {
                                                    ...
                                                    if (!(e < o)) {
                                                        ...
                                                        u = i && ("object" == typeof i || "function" == typeof i) && i.then, v(u) ? r ? u.call(i, a(o, t, F, r), a(o, t, M, r)) : (o++, u.call(i, a(o, t, F, r), a(o, t, M, r), a(o, t, F, t.notifyWith))) : (n !== F && (s = void 0, l = [i]), (r || t.resolveWith)(s, l))
                                                    }
                                                },
                                                c = r ? u : function () {
                                                    try {
                ...
                }), T.ready.then = W.then, "complete" === _.readyState || "loading" !== _.readyState && !_.documentElement.doScroll ? i.setTimeout(T.ready) : (_.addEventListener("DOMContentLoaded", z), i.addEventListener("load", z));
                ...
                function he(e, t) {
                    for (var n, i, r = [], o = 0, a = e.length; o < a; o++)(i = e[o]).style && (n = i.style.display, t ? ("none" === n && (r[o] = J.get(i, "display") || null, r[o] || (i.style.display = "")), "" === i.style.display && ue(i) && (r[o] = de(i))) : "none" !== n && (r[o] = "none", J.set(i, "display", n)));
                ...
                pe = _.createDocumentFragment().appendChild(_.createElement("div")), (me = _.createElement("input")).setAttribute("type", "radio"), me.setAttribute("checked", "checked"), me.setAttribute("name", "t"), pe.appendChild(me), g.checkClone = pe.cloneNode(!0).cloneNode(!0).lastChild.checked, pe.innerHTML = "<textarea>x</textarea>", g.noCloneChecked = !!pe.cloneNode(!0).lastChild.defaultValue, pe.innerHTML = "<option></option>", g.option = !!pe.lastChild;
                var _e = {
                    thead: [1, "<table>", "</table>"],
                    ...
                    for (var o, a, s, l, u, c, f = t.createDocumentFragment(), d = [], h = 0, p = e.length; h < p; h++)
                        if ((o = e[h]) || 0 === o)
                            if ("object" === x(o)) T.merge(d, o.nodeType ? [o] : o);
                                ...
                                for (a = a || f.appendChild(t.createElement("div")), s = (ve.exec(o) || ["", ""])[1].toLowerCase(), l = _e[s] || _e._default, a.innerHTML = l[1] + T.htmlPrefilter(o) + l[2], c = l[0]; c--;) a = a.lastChild;
                    ...
                    n ? (J.set(e, t, !1), T.event.add(e, t, {
                        ...
                        handler: function (e) {
                            ...
                            if (1 & e.isTrigger && this[t]) {
                                ...
                                else if (o = s.call(arguments), J.set(this, t, o), i = n(this, t), this[t](), o !== (r = J.get(this, t)) || i ? J.set(this, t, !1) : r = {}, o !== r) return e.stopImmediatePropagation(), e.preventDefault(), r && r.value
                ...
                T.event = {
                    ...
                    add: function (e, t, n, i, r) {
                        ...
                        if (G(e))
                            for (n.handler && (n = (o = n).handler, r = o.selector), r && T.find.matchesSelector(ae, r), n.guid || (n.guid = T.guid++), (l = g.events) || (l = g.events = Object.create(null)), (a = g.handle) || (a = g.handle = function (t) {
                            ...
                            }), u = (t = (t || "").match(R) || [""]).length; u--;) h = m = (s = Te.exec(t[u]) || [])[1], p = (s[2] || "").split(".").sort(), h && (f = T.event.special[h] || {}, h = (r ? f.delegateType : f.bindType) || h, f = T.event.special[h] || {}, c = T.extend({
                                type: h,
                                origType: m,
                                data: i,
                                handler: n,
                                ...
                                namespace: p.join(".")
                            }, o), (d = l[h]) || ((d = l[h] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(e, i, p, a) || e.addEventListener && e.addEventListener(h, a)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), r ? d.splice(d.delegateCount++, 0, c) : d.push(c), T.event.global[h] = !0)
                    },
                    remove: function (e, t, n, i, r) {
                        var o, a, s, l, u, c, f, d, h, p, m, g = J.hasData(e) && J.get(e);
                        if (g && (l = g.events)) {
                            for (u = (t = (t || "").match(R) || [""]).length; u--;)
                                if (h = m = (s = Te.exec(t[u]) || [])[1], p = (s[2] || "").split(".").sort(), h) {
                                    for (f = T.event.special[h] || {}, d = l[h = (i ? f.delegateType : f.bindType) || h] || [], s = s[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = d.length; o--;) c = d[o], !r && m !== c.origType || n && n.guid !== c.guid || s && !s.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (d.splice(o, 1), c.selector && d.delegateCount--, f.remove && f.remove.call(e, c));
                ...
                function Re(e, t, n, i) {
                    ...
                    var r, o, a, s, u, c, f = 0,
                        ...
                        p = t[0],
                        m = v(p);
                    if (m || d > 1 && "string" == typeof p && !g.checkClone && je.test(p)) return e.each((function (r) {
                        var o = e.eq(r);
                        m && (t[0] = p.call(this, r, o.html())), Re(o, t, n, i)
                    }));
                    if (d && (o = (r = Ee(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === r.childNodes.length && (r = o), o || i)) {
                        for (s = (a = T.map(be(r, "script"), Ie)).length; f < d; f++) u = r, f !== h && (u = T.clone(u, !0, !0), s && T.merge(a, be(u, "script"))), n.call(e[f], u, f);
                        if (s)
                            for (c = a[a.length - 1].ownerDocument, T.map(a, Pe), f = 0; f < s; f++) u = a[f], ye.test(u.type || "") && !J.access(u, "globalEval") && T.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? T._evalUrl && !u.noModule && T._evalUrl(u.src, {
                ...
                T.extend({
                    ...
                    clone: function (e, t, n) {
                        ...
                        if (!(g.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || T.isXMLDoc(e)))
                            for (a = be(s), i = 0, r = (o = be(e)).length; i < r; i++) He(o[i], a[i]);
                        if (t)
                            if (n)
                ...
                function Qe(e, t, n) {
                    var i, r, o, a, s = $e.test(t),
                        l = e.style;
                    return (n = n || Be(e)) && (a = n.getPropertyValue(t) || n[t], s && (a = a.replace(Ue, "$1")), "" !== a || se(e) || (a = T.style(e, t)), !g.pixelBoxStyles() && Me.test(a) && ze.test(t) && (i = l.width, r = l.minWidth, o = l.maxWidth, l.minWidth = l.maxWidth = l.width = a, a = n.width, l.width = i, l.minWidth = r, l.maxWidth = o)), void 0 !== a ? a + "" : a
                }
                ...
                function it(e, t, n) {
                    ...
                    return (!g.boxSizingReliable() && r || !g.reliableTrDimensions() && D(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === T.css(e, "display", !1, i)) && e.getClientRects().length && (r = "border-box" === T.css(e, "boxSizing", !1, i), (o = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + nt(e, t, n || (r ? "border" : "content"), o, i, a) + "px"
                }
                    ...
                    style: function (e, t, n, i) {
                        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                            var r, o, a, s = Y(t),
                                l = $e.test(t),
                                u = e.style;
                            if (l || (t = Ke(s)), a = T.cssHooks[t] || T.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (r = a.get(e, !1, i)) ? r : u[t];
                            "string" === (o = typeof n) && (r = re.exec(n)) && r[1] && (n = ce(e, t, r), o = "number"), null != n && n == n && ("number" !== o || l || (n += r && r[3] || (T.cssNumber[s] ? "" : "px")), g.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, i)) || (l ? u.setProperty(t, n) : u[t] = n))
                        }
                    },
                    css: function (e, t, n, i) {
                        var r, o, a, s = Y(t);
                        return $e.test(t) || (t = Ke(s)), (a = T.cssHooks[t] || T.cssHooks[s]) && "get" in a && (r = a.get(e, !0, n)), void 0 === r && (r = Qe(e, t, i)), "normal" === r && t in et && (r = et[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
                    }
                }), T.each(["height", "width"], (function (e, t) {
                    T.cssHooks[t] = {
                        get: function (e, n, i) {
                            if (n) return !Je.test(T.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? it(e, t, i) : We(e, Ze, (function () {
                                return it(e, t, i)
                            }))
                        },
                        set: function (e, n, i) {
                ...
                function ut() {
                    at && (!1 === _.hidden && i.requestAnimationFrame ? i.requestAnimationFrame(ut) : i.setTimeout(ut, T.fx.interval), T.fx.tick())
                }
                ...
                function ht(e, t, n) {
                    var i, r, o = 0,
                        ...
                        l = function () {
                            if (r) return !1;
                            for (var t = ot || ct(), n = Math.max(0, u.startTime + u.duration - t), i = 1 - (n / u.duration || 0), o = 0, a = u.tweens.length; o < a; o++) u.tweens[o].run(i);
                    ...
                    for (! function (e, t) {
                        ...
                        if (i = ht.prefilters[o].call(u, e, c, u.opts)) return v(i.stop) && (T._queueHooks(u.elem, u.opts.queue).stop = i.stop.bind(i)), i;
                ...
                T.Animation = T.extend(ht, {
                    ...
                    prefilters: [function (e, t, n) {
                        ...
                        for (i in n.queue || (null == (a = T._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, s = a.empty.fire, a.empty.fire = function () {
                            ...
                            for (i in f && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (u = g && g.display) && (u = J.get(e, "display")), "none" === (c = T.css(e, "display")) && (u ? c = u : (he([e], !0), u = e.style.display || u, c = T.css(e, "display"), he([e]))), ("inline" === c || "inline-block" === c && null != u) && "none" === T.css(e, "float") && (l || (d.done((function () {
                                p.display = u
                ...
                T.fn.extend({
                    ...
                    addClass: function (e) {
                        ...
                        return v(e) ? this.each((function (t) {
                            ...
                            if (i = _t(this), n = 1 === this.nodeType && " " + yt(i) + " ") {
                                for (o = 0; o < t.length; o++) r = t[o], n.indexOf(" " + r + " ") < 0 && (n += r + " ");
                                a = yt(n), i !== a && this.setAttribute("class", a)
                            }
                        })) : this
                    },
                    ...
                    toggleClass: function (e, t) {
                        ...
                        return v(e) ? this.each((function (n) {
                            ...
                            else void 0 !== e && "boolean" !== a || ((i = _t(this)) && J.set(this, "__className__", i), this.setAttribute && this.setAttribute("class", i || !1 === e ? "" : J.get(this, "__className__") || ""))
                        })))
                    },
                    hasClass: function (e) {
                        var t, n, i = 0;
                ...
                T.extend(T.event, {
                    trigger: function (e, t, n, r) {
                        ...
                        if (a = d = s = n = n || _, 3 !== n.nodeType && 8 !== n.nodeType && !xt.test(m + T.event.triggered) && (m.indexOf(".") > -1 && (g = m.split("."), m = g.shift(), g.sort()), u = m.indexOf(":") < 0 && "on" + m, (e = e[T.expando] ? e : new T.Event(m, "object" == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = g.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : T.makeArray(t, [e]), f = T.event.special[m] || {}, r || !f.trigger || !1 !== f.trigger.apply(n, t))) {
                            ...
                            for (o = 0;
                                (a = p[o++]) && !e.isPropagationStopped();) d = a, e.type = o > 1 ? l : f.bindType || m, (c = (J.get(a, "events") || Object.create(null))[e.type] && J.get(a, "handle")) && c.apply(a, t), (c = u && a[u]) && c.apply && G(a) && (e.result = c.apply(a, t), !1 === e.result && e.preventDefault());
                ...
                $t.href = Tt.href, T.extend({
                    ...
                    ajax: function (e, t) {
                        ...
                        var n, r, o, a, s, l, u, c, f, d, h = T.ajaxSetup({}, t),
                            p = h.context || h,
                        ...
                        if (g.promise(E), h.url = ((e || h.url || Tt.href) + "").replace(Ht, Tt.protocol + "//"), h.type = t.method || t.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(R) || [""], null == h.crossDomain) {
                            l = _.createElement("a");
                            try {
                        ...
                        for (f in (c = T.event && h.global) && 0 == T.active++ && T.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !qt.test(h.type), r = h.url.replace(Lt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Ot, "+")) : (d = h.url.slice(r.length), h.data && (h.processData || "string" == typeof h.data) && (r += (St.test(r) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (r = r.replace(It, "$1"), d = (St.test(r) ? "&" : "?") + "_=" + Ct.guid++ + d), h.url = r + d), h.ifModified && (T.lastModified[r] && E.setRequestHeader("If-Modified-Since", T.lastModified[r]), T.etag[r] && E.setRequestHeader("If-None-Match", T.etag[r])), (h.data && h.hasContent && !1 !== h.contentType || t.contentType) && E.setRequestHeader("Content-Type", h.contentType), E.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Mt + "; q=0.01" : "") : h.accepts["*"]), h.headers) E.setRequestHeader(f, h.headers[f]);
                        if (h.beforeSend && (!1 === h.beforeSend.call(p, E, h) || u)) return E.abort();
                        if (x = "abort", v.add(h.complete), E.done(h.success), E.fail(h.error), n = Wt(Ft, h, t, E)) {
                        ...
                        function C(e, t, a, l) {
                            var f, d, _, b, w, x = t;
                            u || (u = !0, s && i.clearTimeout(s), n = void 0, o = l || "", E.readyState = e > 0 ? 4 : 0, f = e >= 200 && e < 300 || 304 === e, a && (b = function (e, t, n) {
                            ...
                            }(h, E, a)), !f && T.inArray("script", h.dataTypes) > -1 && T.inArray("json", h.dataTypes) < 0 && (h.converters["text script"] = function () { }), b = function (e, t, n, i) {
                                var r, o, a, s, l, u = {},
                                    c = e.dataTypes.slice();
                                if (c[1])
                            ...
                            }(h, b, E, f), f ? (h.ifModified && ((w = E.getResponseHeader("Last-Modified")) && (T.lastModified[r] = w), (w = E.getResponseHeader("etag")) && (T.etag[r] = w)), 204 === e || "HEAD" === h.type ? x = "nocontent" : 304 === e ? x = "notmodified" : (x = b.state, d = b.data, f = !(_ = b.error))) : (_ = x, !e && x || (x = "error", e < 0 && (e = 0))), E.status = e, E.statusText = (t || x) + "", f ? g.resolveWith(p, [d, x, E]) : g.rejectWith(p, [E, x, _]), E.statusCode(y), y = void 0, c && m.trigger(f ? "ajaxSuccess" : "ajaxError", [E, h, f ? d : _]), v.fireWith(p, [E, x]), c && (m.trigger("ajaxComplete", [E, h]), --T.active || T.event.trigger("ajaxStop")))
                        }
                        return E
                    },
                ...
                T.ajaxSetup({
                    ...
                    if (s || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = v(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Yt, "$1" + r) : !1 !== e.jsonp && (e.url += (St.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function () {
                        return a || T.error(r + " was not called"), a[0]
                    }, e.dataTypes[0] = "json", o = i[r], i[r] = function () {
                        a = arguments
                    }, n.always((function () {
                        void 0 === o ? T(i).removeProp(r) : i[r] = o, e[r] && (e.jsonpCallback = t.jsonpCallback, Xt.push(r)), a && v(o) && o(a[0]), a = o = void 0
                    })), "script"
                })), g.createHTMLDocument = ((Vt = _.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Vt.childNodes.length), T.parseHTML = function (e, t, n) {
                    return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (g.createHTMLDocument ? ((i = (t = _.implementation.createHTMLDocument("")).createElement("base")).href = _.location.href, t.head.appendChild(i)) : t = _), o = !n && [], (r = j.exec(e)) ? [t.createElement(r[1])] : (r = Ee([e], t, o), o && o.length && T(o).remove(), T.merge([], r.childNodes)));
                    var i, r, o
                }, T.fn.load = function (e, t, n) {
                    var i, r, o, a = this,
                        s = e.indexOf(" ");
                    return s > -1 && (i = yt(e.slice(s)), e = e.slice(0, s)), v(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), a.length > 0 && T.ajax({
                        url: e,
                        type: r || "GET",
                        dataType: "html",
                        data: t
                    ...
                    setOffset: function (e, t, n) {
                        var i, r, o, a, s, l, u = T.css(e, "position"),
                            c = T(e),
                            f = {};
                        "static" === u && (e.style.position = "relative"), s = c.offset(), o = T.css(e, "top"), l = T.css(e, "left"), ("absolute" === u || "fixed" === u) && (o + l).indexOf("auto") > -1 ? (a = (i = c.position()).top, r = i.left) : (a = parseFloat(o) || 0, r = parseFloat(l) || 0), v(t) && (t = t.call(e, n, T.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + r), "using" in t ? t.using.call(e, f) : c.css(f)
                    }
                }, T.fn.extend({
                    offset: function (e) {
        ...
        981: (e, t, n) => {
            ...
            function $() {
                if (!this.state.isDestroyed) {
                    ...
                    e.offsets.reference = P(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = I(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = R(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = M(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
                }
            }
            ...
            function K(e, t) {
                Object.keys(t).forEach((function (n) {
                    var i = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && G(t[n]) && (i = "px"), e.style[n] = t[n] + i
                }))
            }
                ...
                offset: {
                    ...
                    fn: function (e, t) {
                        var n = t.offset,
                            ...
                            s = i.split("-")[0],
                            l = void 0;
                        return l = G(+n) ? [+n, 0] : ae(n, o, a, s), "left" === s ? (o.top += l[0], o.left -= l[1]) : "right" === s ? (o.top += l[0], o.left += l[1]) : "top" === s ? (o.left += l[0], o.top -= l[1]) : "bottom" === s && (o.left += l[0], o.top += l[1]), e.popper = o, e
                    },
                    offset: 0
                },
                preventOverflow: {
                ...
                arrow: {
                    ...
                    fn: function (e, t) {
                        ...
                        var r = e.placement.split("-")[0],
                            ...
                            p = u ? "bottom" : "right",
                            m = q(i)[c];
                        l[p] - m < a[d] && (e.offsets.popper[d] -= a[d] - (l[p] - m)), l[d] + m > a[p] && (e.offsets.popper[d] += l[d] + m - a[p]), e.offsets.popper = S(e.offsets.popper);
                        var g = l[d] + l[c] / 2 - m / 2,
                            v = s(e.instance.popper),
                            y = parseFloat(v["margin" + f]),
                            _ = parseFloat(v["border" + f + "Width"]),
                            b = g - e.offsets.popper[d] - y - _;
                        return b = Math.max(Math.min(a[c] - m, b), 0), e.arrowElement = i, e.offsets.arrow = (T(n = {}, d, Math.round(b)), T(n, h, ""), n), e
                    },
                    element: "[x-arrow]"
                },
                flip: {
                    ...
                    fn: function (e, t) {
                        ...
                        return a.forEach((function (s, l) {
                            ...
                            }(o)), e.placement = i + (o ? "-" + o : ""), e.offsets.popper = C({}, e.offsets.popper, R(e.instance.popper, e.offsets.reference, e.placement)), e = M(e.instance.modifiers, e, "flip"))
                        })), e
                    },
                    behavior: "flip",
                    padding: 5,
    ...
    }, n.nmd = e => (e.paths = [], e.children || (e.children = []), e), n(23), n(164), n(707);
    n(978)
})();