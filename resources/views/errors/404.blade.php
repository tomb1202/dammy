...
<head>
	...
	<title>Mehentai.tv | 404 Page</title>

    <script type="text/javascript" src="https://code.jquery.com/jquery-3.7.1.js"></script>

	 <link rel="icon" href="{{ $settings['favicon'] != '' ? sourceSetting($settings['favicon']) : url('assets/img/favicon-150x150.png')}}" sizes="32x32">
    <link rel="icon" href="{{ $settings['favicon'] != '' ? sourceSetting($settings['favicon']) : url('assets/img/favicon-150x150.png')}}" sizes="192x192">
...
<body>
  ...
  <div id="wrap">
	...
	<div id="main-content">
	  <h1>Chúng tôi không tìm thấy trang bạn yêu cầu</h1>

	  <p>Rất tiếc, trang bạn đang tìm kiếm hiện không tồn tại, có thể đã bị xóa hoặc đường dẫn không đúng.</p>

	  <p>Vui lòng kiểm tra lại địa chỉ URL hoặc sử dụng thanh tìm kiếm bên dưới để tìm truyện bạn muốn đọc.</p>

	  <div id="navigation">
		<a class="navigation" href="/">Trang chủ</a>
		<a class="navigation" href="{{route('categories')}}">Chuyên mục</a>
		<a class="navigation" href="{{route('search')}}">Tìm kiếm</a>
	  </div>
	</div>
  </div>
