...
@section('head')
    <title>Truyên Full - Mehentai</title>
    <meta name="description" content="Truyên Full - Mehentai">
    <meta name="robots" content="index, follow">
    <meta name="googlebot-news" content="index,follow">
    <meta itemprop="name" content="Truyên Full - Mehentai">
    <meta itemprop="description" content="Truyên Full - Mehentai">

    <meta itemprop="image" content="{{ sourceSetting($settings['logo']) }}">
    <!--Meta Facebook Page Other-->
    <meta property="og:type" content="website">
    <meta property="og:locale" content="vi_VN">
    <meta property="og:title" content="Truyên Full - Mehentai">
    <meta property="og:description" content="Truyên Full - Mehentai">

    <meta content={{ sourceSetting($settings['logo']) }} property="og:image">
    <meta content={{ sourceSetting($settings['logo']) }} name="twitter:image">

    <meta property="og:url" content="{{ route('completed') }}">
    <link rel="canonical" href="{{ route('completed') }}">
    <link rel="next" href="{{ route('completed') }}?page=2">
    <link rel="prev" href="{{ route('completed') }}">
@endsection
                                ...
                                <div class="entry-header">
                                    <div class="entry-header_wrap">
                                        <div class="entry-title">
                                            <h1 class="item-title h4">Truyện Full</h1>
                                        </div>
                                    </div>
                                </div>
